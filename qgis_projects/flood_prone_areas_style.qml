...
<qgis version="1.7.4-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="FLOODPRONE" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="" label=""/>
      <category symbol="1" value="0" label="0"/>
      <category symbol="2" value="NO" label="NO"/>
      <category symbol="3" value="Yes" label="Yes"/>
      <category symbol="4" value="YES" label="YES"/>
    </categories>
    <symbols>
